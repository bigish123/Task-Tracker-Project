 ...
 */
export default (({ rootNode = document, selector, onDomMutatedCallback }) => DomMutatedPublisher.subscribe(new DomMutatedSubscriber({ rootNode, selector, onDomMutatedCallback })));