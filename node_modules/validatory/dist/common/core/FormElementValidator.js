...
class FormElementValidator {
  ...
  getValidationStateReferenceDomNode() {
    return this.validationStateReferenceSelector !== undefined ? this.formElementDomNode.closest(this.validationStateReferenceSelector) : this.formElementDomNode;
  }
  ...
  isValid() {
    return Promise.resolve(this.emptyFn(this.formElementDomNode) ? { valid: !this.required } : this.validationFn(this.formElementDomNode));
  }
  ...
  validate() {
    ...
    this.validationPromise.promise.then(validationResult => {
      const state = this.required && isEmpty ? STATE.NOT_FILLED : validationResult.valid ? STATE.VALID : validationResult.errorCode ? validationResult.errorCode : STATE.NOT_VALID;
